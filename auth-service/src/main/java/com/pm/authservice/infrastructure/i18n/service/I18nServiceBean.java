package com.pm.authservice.infrastructure.i18n.service;

import com.pm.authservice.infrastructure.i18n.dto.UpdateTranslationDTO;
import com.pm.authservice.infrastructure.i18n.event.TranslationsUpdatedEvent;
import com.pm.authservice.infrastructure.web.exception.BusinessException;
import com.pm.authservice.infrastructure.i18n.model.I18nLabel;
import com.pm.authservice.infrastructure.i18n.model.I18nModule;
import com.pm.authservice.infrastructure.i18n.model.I18nTranslation;
import com.pm.authservice.infrastructure.i18n.model.Language;
import com.pm.authservice.infrastructure.i18n.repository.I18nLabelRepository;
import com.pm.authservice.infrastructure.i18n.repository.I18nModuleRepository;
import com.pm.authservice.infrastructure.i18n.repository.I18nTranslationRepository;
import com.pm.authservice.infrastructure.i18n.repository.LanguageRepository;
