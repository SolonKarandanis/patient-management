...
@Getter
@Setter
@NamedQuery(name = UserJpaEntity.FIND_BY_EMAIL,
        query = "SELECT u FROM UserJpaEntity u "
                + "LEFT JOIN FETCH u.roles r "
                + "WHERE u.email = :email ")
@NamedQuery(name = UserJpaEntity.FIND_BY_DOMAIN_ID,
        query = "SELECT u FROM UserJpaEntity u "
                + "LEFT JOIN FETCH u.roles r "
                + "LEFT JOIN FETCH r.roleOperations ro "
                + "LEFT JOIN FETCH ro.operation operation "
                + "WHERE u.domainId= :domainId ")
@NamedQuery(name = UserJpaEntity.FIND_BY_USERNAME,
        query = "SELECT u FROM UserJpaEntity u "
                + "LEFT JOIN FETCH u.roles r "
                + "WHERE u.username= :username ")
@NamedQuery(name = UserJpaEntity.FIND_ID_BY_DOMAIN_ID,
...
@NamedEntityGraph(name = UserJpaEntity.GRAPH_USERS_ROLES,
...
public class UserJpaEntity {
    ...
    public void removeRoles() {
        Iterator<RoleJpaEntity> iterator = this.roles.iterator();
