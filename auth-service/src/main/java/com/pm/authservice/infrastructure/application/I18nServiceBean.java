...
import com.pm.authservice.infrastructure.web.dto.UpdateTranslationDTO;
import com.pm.authservice.infrastructure.event.TranslationsUpdatedEvent;
import com.pm.authservice.infrastructure.web.exception.BusinessException;
import com.pm.authservice.infrastructure.persistence.entity.I18nLabel;
import com.pm.authservice.infrastructure.persistence.entity.I18nModule;
import com.pm.authservice.infrastructure.persistence.entity.I18nTranslation;
...
import com.pm.authservice.infrastructure.persistence.repository.I18nModuleRepository;
import com.pm.authservice.infrastructure.persistence.repository.I18nTranslationRepository;
import com.pm.authservice.infrastructure.persistence.repository.LanguageRepository;
